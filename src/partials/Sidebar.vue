      ...
      <div class="space-y-8">
        ...
        <div>
          ...
          <router-link to="/" custom v-slot="{ href, navigate, isExactActive }">
            <div class="mt-3 pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r"
              ...
              <a class="block text-gray-800 dark:text-gray-100 truncate transition"
                ...
                <div class="flex items-center">
                  ...
                  <span
                    class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Homepage</span>
                </div>
              </a>
            </div>
          </router-link>
          ...
          <ul class="mt-3">
            ...
            <SidebarLinkGroup v-slot="parentLink" :activeCondition="currentRoute.fullPath.includes('dashboard')">
              <a class="block text-gray-800 dark:text-gray-100 truncate transition"
                :class="currentRoute.fullPath.includes('dashboard') ? 'hover:text-gray-900 dark:hover:text-white' : ''"
                href="#0" @click.prevent="parentLink.handleClick(); sidebarExpanded = true">
                <div class="flex items-center justify-between">
                  <div class="flex items-center">
                    <svg class="shrink-0 fill-current"
                      :class="currentRoute.fullPath.includes('dashboard') ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'"
                      xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                      <path
                    ...
                    <span
                      class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">CPI</span>
                  </div>
                  <!-- Icon -->
                  ...
                  <router-link to="/dashboard/CPIbyIncomeGroup" custom v-slot="{ href, navigate, isExactActive }">
                    <li class="mb-1 last:mb-0">
                      <a class="block transition truncate"
                        ...
                        <span
                          class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">CPI
                          By Household Income Group</span>
                      </a>
                    </li>
                  </router-link>
      ...
      <div class="pt-3 mt-auto">
        <div class="px-3 py-2">
          <div class="bg-slate-50 dark:bg-slate-800/25 rounded-lg p-3">
            ...
            <button
              class="mt-3 w-full text-xs font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300">
              Learn More →
            </button>
          </div>
        </div>
